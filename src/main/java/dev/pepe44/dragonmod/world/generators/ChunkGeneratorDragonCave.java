package dev.pepe44.dragonmod.world.generators;
...
public class ChunkGeneratorDragonCave implements IChunkGenerator {
    ...
    protected static final IBlockState OTHER_BLOCK1 = Blocks.GRASS.getDefaultState();
    protected static final IBlockState OTHER_BLOCK2 = Blocks.DIRT.getDefaultState();
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(BiomeInit.DRAGON_CAVE);
        }
